...
class CatchsmsComTest extends TestCase {
    protected static $name = 'catchsms.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], CatchsmsCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(CatchsmsCom::class, self::$provider);
    }
