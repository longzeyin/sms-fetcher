...
class ReceiveASmsComTest extends TestCase {
    protected static $name = 'receive-a-sms.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], ReceiveASmsCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(ReceiveASmsCom::class, self::$provider);
    }
