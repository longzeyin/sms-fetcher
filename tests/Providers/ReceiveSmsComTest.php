...
class ReceiveSmsComTest extends TestCase {
    protected static $name = 'receive-sms.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], ReceiveSmsCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(ReceiveSmsCom::class, self::$provider);
    }
