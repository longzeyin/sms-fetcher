...
class SmstiboTest extends TestCase {
    protected static $name = 'smstibo.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], Smstibo::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(Smstibo::class, self::$provider);
    }
