...
class SmsnumbersonlineComTest extends TestCase {
    protected static $name = 'smsnumbersonline.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], SmsnumbersonlineCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(SmsnumbersonlineCom::class, self::$provider);
    }
