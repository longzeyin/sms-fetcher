...
class SmsreceivingComTest extends TestCase {
    protected static $name = 'smsreceiving.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], SmsreceivingCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(SmsreceivingCom::class, self::$provider);
    }
