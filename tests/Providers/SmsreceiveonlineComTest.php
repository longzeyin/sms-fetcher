...
class SmsreceiveonlineComTest extends TestCase {
    protected static $name = 'smsreceiveonline.com';
    ...
    public function testInListProviders() {
        ...
        $this->assertEquals(self::$client->getProviders()[self::$name], SmsreceiveonlineCom::class);
    }

    public function testHasProviderInstance() {
        $this->assertInstanceOf(SmsreceiveonlineCom::class, self::$provider);
    }
